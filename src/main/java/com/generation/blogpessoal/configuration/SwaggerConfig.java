    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Projeto Blog Pessoal - Desenvolvido no bootcamp de Desenvolvedor FullStack Java da Generation Brasil")
                .version("v0.0.1")
                .license(new License()
                    .name("Quéren Alves")
                    .url("https://github.com/queren-alves"))
                .contact(new Contact()
                    .name("Quéren Alves")
                    .url("https://github.com/queren-alves")
                    .email("querenhalves@outlook.com")))
